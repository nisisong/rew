$(function(){
      $(".header-sous").click(function(){
        $(".nav").css("display","none"); ;
        $(".header-wide").css("display","inline-block");
        $(".header-sous").css("display","none");
      })
      $(".cha").click(function(){
        $(".nav").css("display","block"); ;
        $(".header-wide").css("display","none");
        $(".header-sous").css("display","block");
      })
    })
    ...
    $(function() {
      $(window).scroll(function () {
        if($(window).scrollTop()>=400) {
          $(".sidebar").fadeIn(300); /* 当滑动到不小于 100px 时，回到顶部图标显示 */
        }else {
          $(".sidebar").fadeOut(300); /* 当滑动到小于(页面被卷去的高度) 100px 时，回到 顶部图标隐藏 */
        }
      });
    });
